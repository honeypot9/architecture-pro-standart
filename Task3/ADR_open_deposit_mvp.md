...
|   3   | Внедрение асихронной передачи с использованием kafka | избыточная модификация для существующей нагрузки на систему; внедрение сьест ресурсы команды, у коротой нет соответствующей экспертизы |
